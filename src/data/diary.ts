...
const diaryData: DiaryItem[] = [
	{
		id: 1,
		content: "凌晨两点，终于把那个困扰了我三天的 bug 修掉了。原因是一个异步函数没有 await，就这么简单。关掉电脑的那一刻，窗外刚好开始下雨，突然觉得这个世界还是挺温柔的。",
	...
	{
		id: 2,
		content: "今天把博客主题从头到尾改了一遍，删掉了一堆不属于我的东西。看着干净的代码库，有种断舍离的快感。\n\n留下来的，才是自己的。",
	...
	{
		id: 3,
		content: "周末在家看了一整天的番，从早上睁眼到晚上闭眼。不是逃避，只是偶尔需要让大脑完全放空。\n\n治愈系动画真的是精神良药。",
	...
	{
		id: 4,
		content: "食堂的麻辣烫越来越难吃了，但还是排了二十分钟的队。有时候坚持一件事，不是因为它好，只是因为习惯了。\n\n明天换个窗口试试。",
	...
	{
		id: 5,
		content: "写代码的时候突然想到一个绝妙的点子，兴奋地打开编辑器准备大干一场。结果发现是个已知问题，三年前就有人在 GitHub 上提过 issue。\n\n人类的创造力，大概就是在重复发明轮子中消耗殆尽的吧。",
	...
	{
		id: 6,
		content: "耳机里单曲循环了一首歌四个小时，直到旋律完全融进了背景噪音里。\n\n有些歌不是用来听的，是用来陪的。",
	...
	{
		id: 7,
		content: "傍晚出去跑步，跑到一半开始走，走着走着就坐路边了。\n\n不是累，是夕阳太好看了，不坐下来欣赏一下对不起这个天气。",
	...
	{
		id: 8,
		content: "帮朋友修了一下午的电脑，最后发现是内存条松了。\n\n朋友说我是天才，我说我只是运气好。但被夸的感觉确实不错，嘿嘿。",
	...
	{
		id: 9,
		content: "翻到去年写的一段代码，完全看不懂了。注释写着「这里逻辑很复杂，以后再优化」。\n\n以后的我：你礼貌吗？",
	...
	{
		id: 10,
		content: "凌晨四点醒来，发现手机没电了。充上电打开一看，零条消息。\n\n不知道该庆幸没人找我，还是该难过没人找我。算了，继续睡吧。",
